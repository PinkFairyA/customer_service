...
const AgentPortal = (props) => {
    ...
    ticketRowElements.forEach(el => {
        const {id, ticket_reason, ticket_status, create_tmstmp, first_name, last_name} = el;
        ticketRowRender.push(<TicketRow key={'tr_row' + id} idHTML={'tr_row' + id} 
        ticket_id={id} ticket_reason={ticket_reason} 
